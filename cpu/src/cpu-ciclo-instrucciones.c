...
{
    t_pcb *proceso = rcv_contexto_ejecucion(socket_cliente);
    printf("%i", proceso->pid);
    printf("%i", proceso->program_counter);

    log_info(logger, proceso->palabra);
...
//             else
//             {
//                 log_error(logger, "Los registros negativos no se guardaran correctamente");
//             }
//         }
