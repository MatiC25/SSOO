...
void cargar_configuraciones(t_config_cpu* config_cpu) {
    ...
    copiar_valor(&config_cpu->ALGORITMO_TLB, config_get_string_value(config, "CANTIDAD_ENTRADAS_TLB")); 
    config_cpu->CANTIDAD_ENTRADAS_TLB = config_get_int_value(config, "ALGORITMO_TLB");
