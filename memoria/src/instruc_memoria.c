...
// void enviar_instruccion_a_cpu(int socket_cliente, int retardo_de_respuesta){
...
//     enviar_paquete(paquete_de_instrucciones, socket_cliente);
...
void enviar_instruccion_a_cpu(int socket_cliente){
    ...
    recibir_program_counter(socket_cliente, &pid, &program_counter);//lo hice gede asi no nos olvidamos
